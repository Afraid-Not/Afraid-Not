...
|     | 대회명                          |    순위    |    기간    | 기술스택                        |
| :-: | ------------------------------- | :--------: | :--------: | ------------------------------- |
| 🥉  | **갑상선암 진단 분류 해커톤**   | **TOP 3**  | 2025.07-08 | `LightGBM` `XGBoost` `Optuna`   |
| 🏅  | **전력사용량 예측 AI 경진대회** | **TOP 6**  | 2025.07-08 | `LightGBM` `XGBoost` `Optuna`   |
| 💳  | **토스 NEXT ML Challenge**      | **TOP 30** | 2025.08-09 | `XGBoost` `Feature Engineering` |
| 💊  | **AI 신약개발 경진대회**        |    참가    | 2025.06-08 | `GNN (GAT/GIN)` `PyTorch` `DGL` |
| ⚛️  | **물리 AI 데이콘**              |   진행중   |  2026.03~  | `Physics-Informed AI`           |
...
### _"연구와 개발을 통해 사람들에게 도움이 되는 것을 만든다"_

<br>

> 철학이 가르쳐준 **'왜'** 라는 질문을,<br>
> AI가 가르쳐준 **'어떻게'** 라는 답으로 연결합니다.
